...
$$
\log(\rho)X + \log(1-\rho)(1-X)
= X \log \frac{\rho}{1-\rho} + \log(1-\rho),
$$
...
$$
\hat\rho_{\text{PM}}=\frac{5}{8}=0.625,
\qquad
\hat\rho_{\text{MAP}}=\frac{4}{6}\approx 0.667.
$$
...
$$
p_X(x)=\frac{1}{x \sqrt{2\pi\sigma^2}}
