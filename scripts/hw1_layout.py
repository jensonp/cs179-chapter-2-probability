...
TEXT_FIELDS = [
    ...
    TextFieldSpec(5, "problem3_q1_reasoning", (125.0, 210.5, 540.0, 284.0), multiline=True, font_size=10, draw_box=True, box_padding=4.0, content_mode="block"),
    TextFieldSpec(5, "problem3_q2_reasoning", (125.0, 333.0, 540.0, 406.0), multiline=True, font_size=10, draw_box=True, box_padding=4.0, content_mode="block"),
    TextFieldSpec(5, "problem3_q3_reasoning", (125.0, 455.0, 540.0, 529.0), multiline=True, font_size=10, draw_box=True, box_padding=4.0, content_mode="block"),
    TextFieldSpec(5, "problem3_q4_reasoning", (125.0, 602.0, 540.0, 742.0), multiline=True, font_size=10, draw_box=True, box_padding=4.0, content_mode="block"),
    TextFieldSpec(6, "problem4_beta_histogram_notes", inset((324.20, 206.69, 542.19, 422.70), 5, 5), multiline=True, font_size=10, content_mode="block"),
    TextFieldSpec(6, "problem4_geometric_histogram_notes", inset((324.20, 487.48, 542.19, 703.48), 5, 5), multiline=True, font_size=10, content_mode="block"),
    ...
    TextFieldSpec(3, "problem1_work", (72.0, 270.0, 392.0, 340.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(3, "problem1_work2", (72.0, 385.0, 392.0, 455.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(3, "problem1_work3", (72.0, 506.0, 392.0, 570.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(3, "problem1_work4", (72.0, 635.0, 392.0, 760.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    # Problem 2: work boxes to the left of each answer blank.
    TextFieldSpec(4, "problem2_work", (72.0, 255.0, 392.0, 360.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(4, "problem2_work2", (72.0, 405.0, 392.0, 515.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    # Problem 5: work areas under each bullet question.
    TextFieldSpec(7, "problem5_short_work_mle", (72.0, 270.0, 540.0, 332.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(7, "problem5_short_work_loglik", (72.0, 440.0, 540.0, 505.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(7, "problem5_short_work", (72.0, 625.0, 540.0, 758.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(8, "problem5_long_work_mle", (72.0, 190.0, 540.0, 335.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(8, "problem5_long_work", (72.0, 450.0, 540.0, 758.0), multiline=True, font_size=10, draw_box=True, box_padding=6.0, content_mode="block"),
    TextFieldSpec(9, "statement_of_collaboration", inset((73.98, 238.30, 543.98, 382.30), 6, 6), multiline=True, font_size=11, content_mode="block"),
]
